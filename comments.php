...
<ol id="commentlist">
	...
	<?php if (1 == $comment->user_id) : ?> 
			<li class="<?php echo $authorcomment; ?>" id="comment-<?php comment_ID() ?>">
		<?php else: ?>
		...
		<?php endif; ?>
			...
			<div class="comments_text">
				...
				<?php comment_text() ?>
				<br /><br />
				<cite><?php comment_type(_c('Comment|noun'), __('Trackback'), __('Pingback')); ?> <?php _e('by'); ?> <?php comment_author_link() ?> &#8212; <?php comment_date() ?> @ <a href="#comment-<?php comment_ID() ?>"><?php comment_time() ?></a></cite> <?php edit_comment_link(__("Edit This"), ' | '); ?>
			</div>
		</li>
		 
		<?php /* Changes every other comment to a different class */
		  if ('comment-alt' == $oddcomment) $oddcomment = 'comment-normal';
		  else $oddcomment = 'comment-alt';
		 ?>
...
<p>
	...
	<br />
	<input type="text" name="author" id="author" value="<?php echo $comment_author; ?>" size="22" tabindex="1" class="required" minlength="2" />
</p>
...
<p>
	...
	<br />
	<textarea name="comment" id="comment" rows="10" tabindex="4" class="required" maxlength="800" ></textarea>
</p>
<p>
